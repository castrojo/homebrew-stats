...
verify-live:
    ...
    for path in "/" "/testhub/" "/overall/" "/contributors/" "/builds/" "/aurora-builds/" "/bazzite-builds/" "/universal-blue/" "/ucore/" "/zirconium/" "/bootcrew/" "/secureblue/" "/wayblue/" "/bluebuildos/"; do
